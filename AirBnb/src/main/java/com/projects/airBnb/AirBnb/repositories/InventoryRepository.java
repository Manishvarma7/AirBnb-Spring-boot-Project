...
public interface InventoryRepository extends JpaRepository<Inventory,Long> {
    ...
    @Query("""
            ...
            WHERE i.room.id = :roomId
                ...
                AND (i.totalCount - i.bookedCount - i.reservedCount) >= :roomsCount
            """)
    @Lock(LockModeType.PESSIMISTIC_WRITE) //while booking this lock annotation
        // will lock the inventory according to user booking so that no other user can book the same
